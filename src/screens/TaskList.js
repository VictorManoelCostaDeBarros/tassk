...
export default class TaskList extends Component {
  ...
  filterTasks = () => {
    ...
    AsyncStorage.setItem('tesksState', JSON.stringify({
  ...
  addTask = async newTask => {
    if(!newTask.desc || !newTask.desc.trim()) {
      Alert.alert('Dados Invalidaos','Descrição não informada!')
      return
    }
      ...
      <View style={styles.container}>
        ...
        <View style={styles.taskList}>
          <FlatList data={this.state.visibleTasks} 
            ...
            renderItem={({item}) => <Task {...item} onToggleTask={this.toggleTask} onDelete={this.deteleTask} />}
          />
        </View>
        <TouchableOpacity 
          activeOpacity={0.7}
